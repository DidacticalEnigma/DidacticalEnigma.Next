...
export async function settingsPanelAttachJs(_: ProgramConfigurationGetResult) {
    ...
    if(isPrivateMode) {
        for (const element of elements) {
            ...
            settingPanel.appendChild(makeElement({
                ...
                children: [
                    makeElement({
                        tagName: "div",
                        classes: ["settings-panel-didactical-enigma-mem-top-row"],
                        children: [
                            makeElement({
                                tagName: "label",
                                children: [
                            ...
                            makeElement({
                                tagName: "div",
                                classes: ["settings-panel-didactical-enigma-mem-spanner"]
                            }),
                            logInButton,
                            logOutButton
                        ]
                    ...
                    makeElement({
                        tagName: "div",
                        classes: ["settings-panel-didactical-enigma-mem-bottom-row"],
                        children: [
                            promptSpan,
                            verificationLink,
                            errorSpan
        ...
        for (const element of elements) {
            ...
            el.innerText = "Not available in public mode";
        }
    }
}